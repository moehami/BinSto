...
export default function Alabama() {
  ...
  if (loading) {
    return <div className="text-center text-xl font-bold mt-8">Loading Alabama Bin Stores...</div>;
  }
  ...
  return (
    <div className="container mx-2 px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Bin Stores in Alabam</h1>


      <div className="mb-2">There is {storesData.data.length} Bins in Alabama </div>
